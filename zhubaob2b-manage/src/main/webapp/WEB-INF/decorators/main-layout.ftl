	...
	<div class="nav">
		<div class="n_nav">
			<ul>
				...
				<li><a href="${managePath}/manage/goods/onshelf.do" target="_blank">商品管理</a></li>
...
<div class="breakout">
		<span>您当前所在位置</span>><span>商家后台管理</span>><span>首页</span>
</div>

<div class="w960 ce clearfix">
	<div class="w170 fl bo1">
		<ul class="ul1">
			<li><a href="${managePath}/manage/main/main.do">全部</a></li>
			<li><a href="${managePath}/manage/order/list.do">订单列表</a></li>
